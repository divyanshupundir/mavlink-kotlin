...
public data class SerialUdbExtraF2B(
  ...
  public override fun serializeV1(): ByteArray {
    ...
    buffer.encodeUInt32(sueFlags)
    buffer.encodeInt32(sueBaromPress)
    buffer.encodeInt32(sueBaromAlt)
    buffer.encodeInt16(suePwmInput1)
    buffer.encodeInt16(suePwmInput2)
    buffer.encodeInt16(suePwmInput3)
    buffer.encodeInt16(suePwmInput4)
    buffer.encodeInt16(suePwmInput5)
    buffer.encodeInt16(suePwmInput6)
    buffer.encodeInt16(suePwmInput7)
    buffer.encodeInt16(suePwmInput8)
    buffer.encodeInt16(suePwmInput9)
    buffer.encodeInt16(suePwmInput10)
    buffer.encodeInt16(suePwmInput11)
    buffer.encodeInt16(suePwmInput12)
    buffer.encodeInt16(suePwmOutput1)
    buffer.encodeInt16(suePwmOutput2)
    buffer.encodeInt16(suePwmOutput3)
    buffer.encodeInt16(suePwmOutput4)
    buffer.encodeInt16(suePwmOutput5)
    buffer.encodeInt16(suePwmOutput6)
    buffer.encodeInt16(suePwmOutput7)
    buffer.encodeInt16(suePwmOutput8)
    buffer.encodeInt16(suePwmOutput9)
    buffer.encodeInt16(suePwmOutput10)
    buffer.encodeInt16(suePwmOutput11)
    buffer.encodeInt16(suePwmOutput12)
    buffer.encodeInt16(sueImuLocationX)
    buffer.encodeInt16(sueImuLocationY)
    buffer.encodeInt16(sueImuLocationZ)
    buffer.encodeInt16(sueLocationErrorEarthX)
    buffer.encodeInt16(sueLocationErrorEarthY)
    buffer.encodeInt16(sueLocationErrorEarthZ)
    buffer.encodeInt16(sueOscFails)
    buffer.encodeInt16(sueImuVelocityX)
    buffer.encodeInt16(sueImuVelocityY)
    buffer.encodeInt16(sueImuVelocityZ)
    buffer.encodeInt16(sueWaypointGoalX)
    buffer.encodeInt16(sueWaypointGoalY)
    buffer.encodeInt16(sueWaypointGoalZ)
    buffer.encodeInt16(sueAeroX)
    buffer.encodeInt16(sueAeroY)
    buffer.encodeInt16(sueAeroZ)
    buffer.encodeInt16(sueBaromTemp)
    buffer.encodeInt16(sueBatVolt)
    buffer.encodeInt16(sueBatAmp)
    buffer.encodeInt16(sueBatAmpHours)
    buffer.encodeInt16(sueDesiredHeight)
    buffer.encodeInt16(sueMemoryStackFree)
  ...
  public companion object : MavMessage.MavCompanion<SerialUdbExtraF2B> {
    ...
    public override fun deserialize(bytes: ByteArray): SerialUdbExtraF2B {
      ...
      val sueFlags = buffer.decodeUInt32()
      val sueBaromPress = buffer.decodeInt32()
      val sueBaromAlt = buffer.decodeInt32()
      val suePwmInput1 = buffer.decodeInt16()
      val suePwmInput2 = buffer.decodeInt16()
      val suePwmInput3 = buffer.decodeInt16()
      val suePwmInput4 = buffer.decodeInt16()
      val suePwmInput5 = buffer.decodeInt16()
      val suePwmInput6 = buffer.decodeInt16()
      val suePwmInput7 = buffer.decodeInt16()
      val suePwmInput8 = buffer.decodeInt16()
      val suePwmInput9 = buffer.decodeInt16()
      val suePwmInput10 = buffer.decodeInt16()
      val suePwmInput11 = buffer.decodeInt16()
      val suePwmInput12 = buffer.decodeInt16()
      val suePwmOutput1 = buffer.decodeInt16()
      val suePwmOutput2 = buffer.decodeInt16()
      val suePwmOutput3 = buffer.decodeInt16()
      val suePwmOutput4 = buffer.decodeInt16()
      val suePwmOutput5 = buffer.decodeInt16()
      val suePwmOutput6 = buffer.decodeInt16()
      val suePwmOutput7 = buffer.decodeInt16()
      val suePwmOutput8 = buffer.decodeInt16()
      val suePwmOutput9 = buffer.decodeInt16()
      val suePwmOutput10 = buffer.decodeInt16()
      val suePwmOutput11 = buffer.decodeInt16()
      val suePwmOutput12 = buffer.decodeInt16()
      val sueImuLocationX = buffer.decodeInt16()
      val sueImuLocationY = buffer.decodeInt16()
      val sueImuLocationZ = buffer.decodeInt16()
      val sueLocationErrorEarthX = buffer.decodeInt16()
      val sueLocationErrorEarthY = buffer.decodeInt16()
      val sueLocationErrorEarthZ = buffer.decodeInt16()
      val sueOscFails = buffer.decodeInt16()
      val sueImuVelocityX = buffer.decodeInt16()
      val sueImuVelocityY = buffer.decodeInt16()
      val sueImuVelocityZ = buffer.decodeInt16()
      val sueWaypointGoalX = buffer.decodeInt16()
      val sueWaypointGoalY = buffer.decodeInt16()
      val sueWaypointGoalZ = buffer.decodeInt16()
      val sueAeroX = buffer.decodeInt16()
      val sueAeroY = buffer.decodeInt16()
      val sueAeroZ = buffer.decodeInt16()
      val sueBaromTemp = buffer.decodeInt16()
      val sueBatVolt = buffer.decodeInt16()
      val sueBatAmp = buffer.decodeInt16()
      val sueBatAmpHours = buffer.decodeInt16()
      val sueDesiredHeight = buffer.decodeInt16()
      val sueMemoryStackFree = buffer.decodeInt16()
