...
public data class SerialUdbExtraF16(
  ...
  public override fun serializeV1(): ByteArray {
    val buffer = Buffer()
    buffer.encodeUInt8Array(sueIdLeadPilot, 40)
    buffer.encodeUInt8Array(sueIdDiyDronesUrl, 70)
  ...
  public companion object : MavMessage.MavCompanion<SerialUdbExtraF16> {
    ...
    public override fun deserialize(bytes: ByteArray): SerialUdbExtraF16 {
      ...
      val sueIdLeadPilot = buffer.decodeUInt8Array(40)
      val sueIdDiyDronesUrl = buffer.decodeUInt8Array(70)
