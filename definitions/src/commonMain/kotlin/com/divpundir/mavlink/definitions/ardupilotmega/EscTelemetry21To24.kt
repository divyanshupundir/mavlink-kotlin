...
public data class EscTelemetry21To24(
  /**
   * Temperature.
   * units = degC
   */
...
) : MavMessage<EscTelemetry21To24> {
  override val instanceCompanion: MavMessage.MavCompanion<EscTelemetry21To24> = Companion
  ...
  public companion object : MavMessage.MavCompanion<EscTelemetry21To24> {
    private const val SIZE_V1: Int = 44

    private const val SIZE_V2: Int = 44

    override val id: UInt = 11_042u

    override val crcExtra: Byte = -55

    override fun deserialize(bytes: ByteArray): EscTelemetry21To24 {
    ...
    public operator fun invoke(builderAction: Builder.() -> Unit): EscTelemetry21To24 = Builder().apply(builderAction).build()
  }
  ...
  public class Builder {
    ...
    public fun build(): EscTelemetry21To24 = EscTelemetry21To24(
      temperature = temperature,
      voltage = voltage,
      current = current,
      totalcurrent = totalcurrent,
