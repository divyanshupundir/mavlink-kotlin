...
public data object CommonDialect : AbstractMavDialect(
  ...
  mapOf(
    ...
    Airspeed.id to Airspeed,
    GlobalPositionSensor.id to GlobalPositionSensor,
    ...
    FigureEightExecutionStatus.id to FigureEightExecutionStatus,
    ...
    AvailableModes.id to AvailableModes,
    CurrentMode.id to CurrentMode,
    AvailableModesMonitor.id to AvailableModesMonitor,
