...
public data class EscTelemetry25To28(
  /**
   * Temperature.
   * units = degC
   */
...
) : MavMessage<EscTelemetry25To28> {
  override val instanceCompanion: MavMessage.MavCompanion<EscTelemetry25To28> = Companion
  ...
  public companion object : MavMessage.MavCompanion<EscTelemetry25To28> {
    private const val SIZE_V1: Int = 44

    private const val SIZE_V2: Int = 44

    override val id: UInt = 11_043u

    override val crcExtra: Byte = -63

    override fun deserialize(bytes: ByteArray): EscTelemetry25To28 {
    ...
    public operator fun invoke(builderAction: Builder.() -> Unit): EscTelemetry25To28 = Builder().apply(builderAction).build()
  }
  ...
  public class Builder {
    ...
    public fun build(): EscTelemetry25To28 = EscTelemetry25To28(
      temperature = temperature,
      voltage = voltage,
      current = current,
      totalcurrent = totalcurrent,
