...
public data class SerialUdbExtraF19(
  ...
  override val instanceCompanion: MavMessage.MavCompanion<SerialUdbExtraF19> = Companion
  ...
  public companion object : MavMessage.MavCompanion<SerialUdbExtraF19> {
    ...
    public operator fun invoke(builderAction: Builder.() -> Unit): SerialUdbExtraF19 = Builder().apply(builderAction).build()
  }
