 ...
 * @param angularVelocityX X component of angular velocity (positive: rolling to the right). The frame is described in the message description. NaN to be ignored.
 * units = rad/s
 * @param angularVelocityY Y component of angular velocity (positive: pitching up). The frame is described in the message description. NaN to be ignored.
 * units = rad/s
 * @param angularVelocityZ Z component of angular velocity (positive: yawing to the right). The frame is described in the message description. NaN to be ignored.
 * units = rad/s
 */
@GeneratedMavMessage(
  id = 284u,
...
public data class GimbalDeviceSetAttitude(
  ...
  public companion object : MavMessage.MavCompanion<GimbalDeviceSetAttitude> {
    ...
    public operator fun invoke(builderAction: Builder.() -> Unit): GimbalDeviceSetAttitude = Builder().apply(builderAction).build()
  }
