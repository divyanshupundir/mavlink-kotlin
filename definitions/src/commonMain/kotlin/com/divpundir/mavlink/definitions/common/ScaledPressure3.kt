...
public data class ScaledPressure3(
  ...
  override val instanceCompanion: MavMessage.MavCompanion<ScaledPressure3> = Companion
  ...
  public companion object : MavMessage.MavCompanion<ScaledPressure3> {
    ...
    public operator fun invoke(builderAction: Builder.() -> Unit): ScaledPressure3 = Builder().apply(builderAction).build()
  }
