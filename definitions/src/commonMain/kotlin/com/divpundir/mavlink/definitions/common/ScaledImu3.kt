...
public data class ScaledImu3(
  ...
  override val instanceCompanion: MavMessage.MavCompanion<ScaledImu3> = Companion
  ...
  public companion object : MavMessage.MavCompanion<ScaledImu3> {
    ...
    override val id: UInt = 129u

    override val crcExtra: Byte = 46

    override fun deserialize(bytes: ByteArray): ScaledImu3 {
    ...
    public operator fun invoke(builderAction: Builder.() -> Unit): ScaledImu3 = Builder().apply(builderAction).build()
  }
