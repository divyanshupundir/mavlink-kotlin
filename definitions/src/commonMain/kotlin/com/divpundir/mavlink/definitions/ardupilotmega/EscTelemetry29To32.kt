...
public data class EscTelemetry29To32(
  /**
   * Temperature.
   * units = degC
   */
...
) : MavMessage<EscTelemetry29To32> {
  override val instanceCompanion: MavMessage.MavCompanion<EscTelemetry29To32> = Companion
  ...
  public companion object : MavMessage.MavCompanion<EscTelemetry29To32> {
    private const val SIZE_V1: Int = 44

    private const val SIZE_V2: Int = 44

    override val id: UInt = 11_044u

    override val crcExtra: Byte = -67

    override fun deserialize(bytes: ByteArray): EscTelemetry29To32 {
    ...
    public operator fun invoke(builderAction: Builder.() -> Unit): EscTelemetry29To32 = Builder().apply(builderAction).build()
  }
  ...
  public class Builder {
    ...
    public fun build(): EscTelemetry29To32 = EscTelemetry29To32(
      temperature = temperature,
      voltage = voltage,
      current = current,
      totalcurrent = totalcurrent,
