...
public data class EscTelemetry13To16(
  /**
   * Temperature.
   * units = degC
   */
...
) : MavMessage<EscTelemetry13To16> {
  override val instanceCompanion: MavMessage.MavCompanion<EscTelemetry13To16> = Companion
  ...
  public companion object : MavMessage.MavCompanion<EscTelemetry13To16> {
    private const val SIZE_V1: Int = 44

    private const val SIZE_V2: Int = 44

    override val id: UInt = 11_040u

    override val crcExtra: Byte = -124

    override fun deserialize(bytes: ByteArray): EscTelemetry13To16 {
    ...
    public operator fun invoke(builderAction: Builder.() -> Unit): EscTelemetry13To16 = Builder().apply(builderAction).build()
  }
  ...
  public class Builder {
    ...
    public fun build(): EscTelemetry13To16 = EscTelemetry13To16(
      temperature = temperature,
      voltage = voltage,
      current = current,
      totalcurrent = totalcurrent,
