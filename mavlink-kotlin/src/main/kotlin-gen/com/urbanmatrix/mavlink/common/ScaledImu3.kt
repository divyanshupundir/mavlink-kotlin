...
public data class ScaledImu3(
  ...
  public companion object {
    ...
    private val DESERIALIZER: MavDeserializer<ScaledImu3> = MavDeserializer { bytes ->
      if (bytes.size != SIZE) {
        throw MavDeserializationException(
          """Invalid ByteArray size for ScaledImu3: Expected=$SIZE Actual=${bytes.size}"""
        )
      }
    ...
    private val METADATA: MavMessage.Metadata<ScaledImu3> = MavMessage.Metadata(ID, CRC,
        DESERIALIZER)
